  ...
  const openCamera = useCallback(async () => {
    ...
    if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
      ...
      toast({
        ...
        description: 'Seu navegador não suporta acesso à câmera. Use a opção de upload de arquivo.',
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: 'Não foi possível acessar a câmera. Verifique as permissões do navegador ou use a opção de upload.',
      });
    }
