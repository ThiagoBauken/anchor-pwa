-- =====================================================
-- AnchorView - Complete Database Creation Script
-- Execute: psql 'postgresql://privado:privado12!@private_alpdb:5432/privado?sslmode=disable' -f create-all-tables.sql
-- =====================================================
