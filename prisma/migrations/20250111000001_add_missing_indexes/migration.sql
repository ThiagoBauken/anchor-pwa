...
-- Teams table
CREATE INDEX IF NOT EXISTS "Team_companyId_idx"
ON "teams"("company_id");

-- TeamMember table
CREATE INDEX IF NOT EXISTS "TeamMember_teamId_idx"
...
-- AnchorPoint table
CREATE INDEX IF NOT EXISTS "anchor_points_floor_plan_id_idx"
...
CREATE INDEX IF NOT EXISTS "pathology_markers_created_by_id_idx"
...
CREATE INDEX IF NOT EXISTS "User_companyId_active_idx"
...
CREATE INDEX IF NOT EXISTS "anchor_points_project_next_inspection_idx"
ON "anchor_points"("project_id", "next_inspection_date");

-- ProjectTeamPermission: cleanup expired permissions
CREATE INDEX IF NOT EXISTS "project_team_permissions_expiresAt_idx"
